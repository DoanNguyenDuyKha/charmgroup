...
function LastAction() {
    Mobile.matches ? OverlayMenu.style.transition = "transform 0.4s ease-in-out" : OverlayMenu.style.transition = "transform 0.6s ease-in-out";
    var e = document.querySelector(".bg-degree");
    e && (e.style.transition = "transform 0.6s ease-in-out")
}
var isFirst = 0;
...
function NavClickFn() {
    var t = document.querySelector(".navigation")
      ...
      , n = Header.querySelector(".main-menu")
      , r = Header.querySelector(".overlay-menu")
      , e = Header.querySelector(".navigation > span");
    gsap.set(".nav-item", {
        x: "150%",
        opacity: 0
    }),
    NavClick.addEventListener("click", function(e) {
        ...
        NavClick.classList.contains("show") ? (t.scrollTop = 0,
        n.classList.remove("show"),
        setTimeout(function() {
            Array.from([t, r, NavClick], function(e) {
        ...
        slideMask && windscroll <= window.innerHeight / 2 && slideMask.querySelector(".slidebox-play").click()) : (t.scrollTop = 0,
        Array.from([t, n, r, NavClick], function(e) {
        ...
        slideMask && windscroll <= window.innerHeight / 2 && slideMask.querySelector(".slidebox-pause").click()),
        u(),
        !1
    }),
    e.addEventListener("click", function(e) {
...
function Search() {
    var t = document.querySelector(".search-but")
      , o = document.querySelector(".search-overlay")
      , e = document.querySelector(".close-search")
      , n = document.querySelector(".search-overlay > span");
    t.addEventListener("click", function(e) {
        e.preventDefault(),
        t.classList.contains("active") ? (o.classList.remove("show"),
        t.classList.remove("active"),
        document.querySelector(".search-form").classList.remove("active"),
        Container.classList.remove("blur"),
        Body.classList.remove("no-scroll"),
        HTML.classList.remove("no-scroll")) : (o.classList.add("show"),
        t.classList.add("active"),
        document.querySelector(".search-form").classList.add("active"),
        document.querySelector(".search-form .holder").classList.remove("hide"),
    ...
    document.getElementById("qsearch").addEventListener("keydown", function(e) {
        13 === e.keyCode && execSearch()
    }),
    document.querySelector(".form-row-search svg").addEventListener("click", function(e) {
        e.preventDefault(),
        execSearch()
    }),
    Array.from([e, n], function(e) {
        e.addEventListener("click", function(e) {
            e.preventDefault(),
            hasClass(t, "active") && t.click()
        })
    })
}
var SlidePicture = {
